 ...
 * @author Mohak
 */
public class Useless_Add_New_Person extends javax.swing.JFrame {
...
String result = sb.toString();
    ...
    public Useless_Add_New_Person() {
        try{
            mycon= DriverManager.getConnection("jdbc:mysql://localhost:3306/crime","root","1234");
    ...
    private void btAddtodatabaseMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btAddtodatabaseMouseClicked
        ...
        try
        {
            Connection mycon1= DriverManager.getConnection("jdbc:mysql://localhost:3306/crime","root","1234");
            String insert="insert into station1 values(?,?,?,?,?,?,?,?,?,?)";
