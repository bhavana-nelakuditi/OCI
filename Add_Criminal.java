...
public class Add_Criminal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Skin Complexion:");

        jLabel5.setText("Marks:");

        jLabel6.setText("Type of Crime:");

        jLabel7.setText("Add Criminal");
 ...
 try{
     ...
     String skin=jTextField4.getText();
     ...
     String query="Insert into criminaldetails values('"+name+"','"+age+"','"+height+"','"+skin+"','"+marks+"','"+type+"');";
